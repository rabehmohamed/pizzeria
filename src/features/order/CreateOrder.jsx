    ...
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div>
          ...
          <Button disabled={isSubmtting || isLoadingAddress} type="primary">
            {isSubmtting ? 'Placing Order' : `Order now from $${totalPrice}`}
          </Button>
        </div>
      </Form>
    </div>
...
export async function action({request}){
  ...
  const errors = {};
  if(!isValidPhone(order.phone)) errors.phone = "Please give use correct number"
